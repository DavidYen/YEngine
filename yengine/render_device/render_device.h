#ifndef YENGINE_RENDER_DEVICE_RENDER_DEVICE_H
#define YENGINE_RENDER_DEVICE_RENDER_DEVICE_H

#include <stdint.h>

#include "yengine/render_device/pixel_format.h"
#include "yengine/render_device/vertex_format.h"
...
namespace RenderDevice {
  void Initialize(const ycommon::platform::PlatformHandle& handle,
...
#endif // YENGINE_RENDER_DEVICE_RENDER_DEVICE_H
