...
class RendererTest : public ::testing::Test {
 protected:
  ...
  virtual void SetUp() {
    ...
    core::StringTable::Initialize(32, 128, mMemBuffer.Allocate(10240), 10240);
    render_device::RenderDevice::Initialize(mHandle, gTestWidth, gTestHeight,
...
TEST_F(RendererTest, RegisterRenderTargetTest) {
  ...
  const render_device::PixelFormat format =
      static_cast<render_device::PixelFormat>(123);
...
TEST_F(RendererTest, RegisterShaderDataTest) {
  ...
  const render_device::VertexShaderID vertex_shader_id = 10;
  const render_device::PixelShaderID pixel_shader_id = 20;
  render_device::RenderDeviceMock::ExpectCreateVertexShader(
      vertex_shader_id, vertex_shader, sizeof(vertex_shader));
  render_device::RenderDeviceMock::ExpectCreatePixelShader(
  ...
  render_device::RenderDeviceMock::ExpectReleasePixelShader(pixel_shader_id);
  render_device::RenderDeviceMock::ExpectReleaseVertexShader(vertex_shader_id);
...
TEST_F(RendererTest, BasicActivationTest) {
  ...
  const render_device::PixelFormat format =
      static_cast<render_device::PixelFormat>(456);
